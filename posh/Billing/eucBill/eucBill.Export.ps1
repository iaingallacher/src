...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       23/07/2014 8:38 PM
...
function Call-MainForm_psf
{
	...
	$btnOpenCSV_Click= {
		...
		$lblCSVFile.Text = $openfiledialog1.FileName
		$frmMain.Text = "End User Compute Bill - " + $openfiledialog1.FileName
	...
	function Process-CSV
	{
		...
		$begin = $dateStartBill.Value
		$end = $dateEndBill.Value
		Write-Host $begin.Month
		Write-Host $end.Month
		...
		$dgCSV.DataSource = $billCSV
		$lblRows.Text = @($billCSV).count - 1
		$frmMain.Refresh()
